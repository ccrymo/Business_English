const Header = ({ title, currentQuestion, totalQuestions, correctAnswers }) => {
  return (
    <header className="fixed top-0 left-0 right-0 z-10 bg-stone-800 text-white p-4 flex justify-between items-center">
      <div className="flex flex-row text-lg items-center">
        <h1 className="text-2xl font-bold">Grade:</h1>
        <p className="text-lg ml-5">{correctAnswers} / 50%</p>
      </div>
      <div className="flex flex-row text-lg items-center">
